...
def preprocess_hospital(filename):
    ...
    hospital_data = hospital_data[~(hospital_data.geometry.is_empty | hospital_data.geometry.isna())]
...
def preprocess_charging_stations(filename):
    ...
    charging_stations_data = charging_stations_data[~(charging_stations_data.geometry.is_empty | charging_stations_data.geometry.isna())]
...
def preprocess_colleges(filename):
    ...
    college_data = college_data[~(college_data.geometry.is_empty | college_data.geometry.isna())]
    return college_data
...
def preprocess_pools(filename):
    ...
    pool_data = pool_data[~(pool_data.geometry.is_empty | pool_data.geometry.isna())]
    return pool_data
...
def preprocess_community_centers(filename):
    ...
    comm_center_data = comm_center_data[~(comm_center_data.geometry.is_empty | comm_center_data.geometry.isna())]
...
def preprocess_public_schools(filename):
    ...
    public_school_data = public_school_data[~(public_school_data.geometry.is_empty | public_school_data.geometry.isna())]
...
def preprocess_private_schools(filename):
    ...
    private_school_data = private_school_data[~(private_school_data.geometry.is_empty | private_school_data.geometry.isna())]
...
def preprocess_police_stations(filename):
    ...
    station_data = station_data[~(station_data.geometry.is_empty | station_data.geometry.isna())]
    return station_data
